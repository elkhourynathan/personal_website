  ...
  return (
    <div className="md:sticky top-12 flex flex-row-reverse md:flex-col gap-4 md:space-y-8">
      ...
      <div className="w-2/3 md:w-full">
        <h1 className="font-serif text-3xl font-light tracking-wide mb-3 text-zinc-900 dark:text-zinc-50">
          {aboutMe.name}
        </h1>
        {aboutMe.altName && (
        ...
        {aboutMe.skills && (
          <div
            className="mt-8 text-xs text-zinc-700 dark:text-zinc-400"
            dangerouslySetInnerHTML={{ __html: aboutMe.skills }}
          />
        )}
      </div>
    </div>
